...
\begin{itemize}
    ...
    \item \textbf{What are the two types of thread cancellation?}
        \begin{itemize}
            ...
            \item \textbf{Synchronous Cancellation:} The target thread to be cancelled periodically checks whether it should terminate, allowing it to terminate itself in an orderly fashion (clean up and release resources).
        \end{itemize}
\end{itemize}
