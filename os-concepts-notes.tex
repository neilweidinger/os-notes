...
% all of this to change colors of sections
\usepackage{silence}
\WarningFilter{latex}{Command \underbar}
\WarningFilter{latex}{Command \underline}
\usepackage{xcolor}
\usepackage{sectsty}
\definecolor{partcolor}{RGB}{0, 68, 94}
\partfont{\color{partcolor}}
...
\part*{OS Concepts Chapter 1: Introduction}
\addcontentsline{toc}{part}{Chapter 1: Introduction}
...
\part*{OS Concepts Chapter 2: OS Structures}
\addcontentsline{toc}{part}{Chapter 2: OS Structures}
...
\part*{OS Concepts Chapter 3: Processes}
\addcontentsline{toc}{part}{Chapter 3: Processes}
...
\part*{OS Concepts Chapter 4: Threads \& Concurrency}
\addcontentsline{toc}{part}{Chapter 4: Threads \& Concurrency}
...
\part*{OS Concepts Chapter 5: CPU Scheduling}
\addcontentsline{toc}{part}{Chapter 5: CPU Scheduling}
...
\addcontentsline{toc}{subsection}{5.3.1: First Come First Served (-CFS) Scheduling}
...
\part*{OS Concepts Chapter 6: Synchronization Tools}
\addcontentsline{toc}{part}{Chapter 6: Synchronization Tools}
...
\part*{OS Concepts Chapter 9: Main Memory}
\addcontentsline{toc}{part}{Chapter 9: Main Memory}
...
\part*{OS Concepts Chapter 10: Virtual Memory}
\addcontentsline{toc}{part}{Chapter 10: Virtual Memory}
...
\addcontentsline{toc}{section}{10.3: Copy-on-Write}
...
\addcontentsline{toc}{section}{10.4: Page Replacement}

\subsection*{10.4.1: Basic Page Replacement}
\addcontentsline{toc}{subsection}{10.4.1: Basic Page Replacement}
...
\addcontentsline{toc}{subsection}{10.4.2: FIFO Page Replacement}
...
\addcontentsline{toc}{subsection}{10.4.3: Optimal Page Replacement (Belady's Algorithm)}
...
\addcontentsline{toc}{subsection}{10.4.4: LRU Page Replacement}
...
\addcontentsline{toc}{subsection}{10.4.5: LRU-Approximation Page Replacement Algorithms}
...
\addcontentsline{toc}{subsection}{10.4.6: Counting-Based Page Replacement}
...
\addcontentsline{toc}{subsection}{10.4.7: Page-Buffering Algorithms}
...
\addcontentsline{toc}{subsection}{10.4.8: Applications and Page Replacement}
...
\part*{OS Concepts Chapter 11: Mass-Storage Structure}
\addcontentsline{toc}{part}{Chapter 11: Mass-Storage Structure}
...
\addcontentsline{toc}{section}{11.2: HDD Scheduling}
...
\addcontentsline{toc}{section}{11.4: Error Detection and Correction}

\begin{itemize}
    \item \textbf{Error Detection:} Error detection determines if a problem has occurred. E.g. a bitflip in DRAM, contents of a network packet altered during transmission, or a block of data changed between when it was written and when it was read. Does not include error correction, data must be discarded.
...
\part*{OS Concepts Chapter 12: I/O Systems}
\addcontentsline{toc}{part}{Chapter 12: I/O Systems}
...
\part*{OS Concepts Chapter 13: File-System Interface}
\addcontentsline{toc}{part}{Chapter 13: File-System Interface}
